  ...
  {specialities.map((specialty, index) => (
    <option key={index} value={specialty}>
      {specialty}
        ...
        <textarea onChange={(e)=>setAbout(e.target.value)} value={about} className="w-full px-4 pt-2 border rounded" name="" placeholder="write about doctor" required rows={5} id=""></textarea>
